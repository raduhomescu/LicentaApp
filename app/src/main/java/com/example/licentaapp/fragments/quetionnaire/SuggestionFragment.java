...
public class SuggestionFragment extends Fragment implements PhoneAdapter.OnFavoriteButtonClickListener {
    ...
    private boolean filterPhone(Phone phone) {
        ...
        int resolution2 = Integer.valueOf(phone.getResolution().substring((phone.getResolution().indexOf('x') + 1)).replaceAll("\\s+", ""));
        ...
        } else if (filterList.get(6).equals(getString(R.string.professional))) {
